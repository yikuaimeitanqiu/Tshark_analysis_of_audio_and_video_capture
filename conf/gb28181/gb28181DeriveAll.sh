...
CALLID_4=`awk -F , '{if(!a[$7,$10,$12,$13]++) print NR,$7,$10,$11,$12,",",$13}' $SIPDIR | grep "video" | awk -F , '{print $2}' | awk -F " " '{print $2}' | awk '{if(!a[$1]++) print $1}'`
...
-w $DIR/report/gb28181deriveall.pcap \
&>/dev/null 
